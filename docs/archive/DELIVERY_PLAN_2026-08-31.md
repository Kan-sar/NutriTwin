...
- Python 3.12–3.14 is supported and 3.14.5 was used locally. Flutter stable 3.47.2 and Dart 3.13.2 are downloaded locally, but the one-time Flutter tool snapshot stalled; Android Studio/SDK is not installed. See `../FLUTTER_SETUP_HANDOFF.md`.
